...
py.init()
py.mixer.music.load("C:/Users/Anurag/Downloads/game-music-loop-7-145285.mp3")
...
class Ludo:
    def __init__(self, root,six_side_block,five_side_block,four_side_block,three_side_block,two_side_block,one_side_block):
        ...
        # Make canvas
        self.make_canvas = Canvas(self.window, width=1000, height=700)
        self.make_canvas.pack(fill=BOTH,expand=7)

        # Load the background image
        background_image = PhotoImage(file="C:/Users/Anurag/Downloads/bg.png")  # Path to your image file
        # background_image=PhotoImage.transform.scale(background_image,(1500,790))
        # Add the background image to the canvas
        self.make_canvas.create_image(0, 0, anchor="nw",image=background_image)
    ...
    def instruction_btn_red(self):
        ...
        name=Entry(self.make_canvas,bg="#4d4dff",fg="gold",font=("Arial",7,"bold")).place(x=0,y=15+140+40)
    ...
    def instruction_btn_sky_blue(self):
        ...
        name2 = Entry(self.make_canvas,bg="#4d4dff", fg="gold", font=("Arial", 7, "bold")).place(x=0,y=15+(40*6+40*3)+40 + 110+ 40)
    ...
    def instruction_btn_yellow(self):
        ...
        name3 = Entry(self.make_canvas, bg="#4d4dff", fg="gold", font=("Arial", 7, "bold")).place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 3),y=15 + (40 * 6 + 40 * 3) + 40 + 110 + 40)
    ...
    def instruction_btn_green(self):
        ...
        name4= Entry(self.make_canvas, bg="#4d4dff", fg="gold", font=("Arial",7, "bold")).place(x=100+(40*6+40*3+40*6+3), y=15 + 140+40)
...
if __name__ == '__main__':
    ...
    window.iconbitmap("C:/Users/Anurag/Downloads/ludoimages/Images/ludo_icon1.jpg")
    # Load and resize images
    block_six_side = ImageTk.PhotoImage(Image.open("C:/Users/Anurag/Downloads/ludoimages/Images/6_block.png").resize((33, 33), resample=Image.BILINEAR))
    block_five_side = ImageTk.PhotoImage(Image.open("C:/Users/Anurag/Downloads/ludoimages/Images/5_block.png").resize((33, 33), resample=Image.BILINEAR))
    block_four_side = ImageTk.PhotoImage(Image.open("C:/Users/Anurag/Downloads/ludoimages/Images/4_block.png").resize((33, 33), resample=Image.BILINEAR))
    block_three_side = ImageTk.PhotoImage(Image.open("C:/Users/Anurag/Downloads/ludoimages/Images/3_block.png").resize((33, 33), resample=Image.BILINEAR))
    block_two_side = ImageTk.PhotoImage(Image.open("C:/Users/Anurag/Downloads/ludoimages/Images/2_block.png").resize((33, 33), resample=Image.BILINEAR))
    block_one_side = ImageTk.PhotoImage(Image.open("C:/Users/Anurag/Downloads/ludoimages/Images/1_block.png").resize((33, 33), resample=Image.BILINEAR))
